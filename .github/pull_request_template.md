...
- [ ] This will result in a behavioral or conformance change.
- [ ] This will result in a change to the API.

Describe any API, schema, wire-format, MSRV, behavioral, or conformance
compatibility effects. Write `None` when there are none.
...
- [ ] I have the right to submit this contribution, and every commit includes a
  `Signed-off-by` trailer that exactly matches its Git author.
